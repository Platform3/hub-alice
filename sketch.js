...
function setup() {
  ...
  // make buttons
  makebuttons(0, accessButtonDefaultSize, accessButtonDefaultSize, button1X, button1Y)
  makebuttons(1, accessButtonDefaultSize, accessButtonDefaultSize, button2X, button2Y)
  makebuttons(2, accessButtonDefaultSize, accessButtonDefaultSize, button3X, button3Y)
  makebuttons(3, accessButtonDefaultSize, accessButtonDefaultSize, button4X, button4Y)
  makebuttons(4, accessButtonDefaultSize, accessButtonDefaultSize, button5X, button5Y)
...
function draw() {
  ...
  accessButtons.forEach(accessButton => {
    accessButton.position(vidWidth * accessButton.xPos + modX - accessButtonSize / 2, vidHeight * accessButton.yPos + modY - accessButtonSize / 2);
